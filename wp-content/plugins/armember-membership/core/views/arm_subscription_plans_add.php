                                ...
                                <td>
                                    ...
                                    <div class="arm_paid_finite_fixed_expiry_date" id="arm_paid_finite_fixed_expiry_date">
                                        ...
                                        <div class="arm_expiry_fix_date_box arm_position_relative" id="arm_expiry_fix_date_box" >
                                            ...
                                            <input type="text" id="arm_finite_plan_expiry_date" value="<?php echo ( (isset($plan_options['expiry_date']) && !empty($plan_options['expiry_date'])) ? date('m/d/Y', strtotime($plan_options['expiry_date'])) : ''); ?>" data-date_format="m/d/Y" name="arm_subscription_plan_options[expiry_date]" class="arm_finite_plan_expiry_date" data-editmode="<?php echo ($edit_mode) ? '1' : '0'; ?>" data-msg-required="<?php _e('Please select expiry date.', 'ARMember'); ?>"/>
                                        </div>
                                    </div>
