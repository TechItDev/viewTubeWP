        ...
        <div class="arm_datatable_filters">
            ...
            <div>
                ...
                <div class="arm_datatable_filter_item arm_filter_pstatus_label arm_margin_left_0" >
                    <input type="text" id="arm_filter_pstart_date" placeholder="<?php _e('Start Date', 'ARMember'); ?>" data-date_format="m/d/Y"/>
                </div>
                <div class="arm_datatable_filter_item arm_filter_pstatus_label">
                    <input type="text" id="arm_filter_pend_date" placeholder="<?php _e('End Date', 'ARMember'); ?>" data-date_format="m/d/Y"/>
                </div>
