...
function videotube_core_loginform_widget_register() {
	register_widget('VideoTube_Core_Widget_LoginForm');
}
add_action('widgets_init', 'videotube_core_loginform_widget_register');

class VideoTube_Core_Widget_LoginForm extends WP_Widget{
	
	function __construct(){
		$widget_ops = array( 'classname' => 'mars-loginform-widget', 'description' => __('[VideoTube] Login Form', 'videotube-core') );
	
		parent::__construct( 'mars-loginform-widget' , __('[VideoTube] Login Form', 'videotube-core') , $widget_ops);
	}	
