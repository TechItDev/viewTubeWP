...
if( !function_exists( 'videotube_core_home_v3_fullwidth_4cols' ) ){
	function videotube_core_home_v3_fullwidth_4cols($data) {
		$template               = array();
		$template['name']       = __( 'Homepage V3 - Fullwidth - 4 Cols', 'videotube-core' );
		...
		$template['custom_class'] = 'videotube_core_home_v3_fullwidth_4cols';
...
CONTENT;
	...
	add_filter( 'vc_load_default_templates', 'videotube_core_home_v3_fullwidth_4cols', 50, 1 );
}
