...
if( !function_exists( 'videotube_core_home_v4_fullwidth_6cols' ) ){
	function videotube_core_home_v4_fullwidth_6cols($data) {
		$template               = array();
		$template['name']       = __( 'Homepage V4 - Fullwidth - 6 Cols', 'videotube-core' );
		...
		$template['custom_class'] = 'videotube_core_home_v4_fullwidth_6cols';
...
CONTENT;
	...
	add_filter( 'vc_load_default_templates', 'videotube_core_home_v4_fullwidth_6cols', 60, 1 );
}
