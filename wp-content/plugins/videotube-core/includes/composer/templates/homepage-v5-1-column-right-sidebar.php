...
if( !function_exists( 'videotube_core_home_v5_1col_right_sidebar' ) ){
	function videotube_core_home_v5_1col_right_sidebar($data) {
		$template               = array();
		$template['name']       = __( 'Homepage V5 - 1Col - Right Sidebar', 'videotube-core' );
		...
		[vc_row][vc_column width="1/1"][vc_row_inner][vc_column_inner width="8/12"][videotube type="main" show="10" id="video-widget-3911" rows="1" columns="1" navigation="on" title="Recent Videos" thumbnail_size=" blog-large-thumb" orderby="ID" order="DESC"][/vc_column_inner][vc_column_inner width="4/12" el_class="sidebar"][videotube_core_vc_socialsbox title="Socials Box"][videotube type="widget" show="3" id="video-widget-3338" rows="1" columns="1" title="Latest Videos" orderby="ID" order="DESC"][vc_wp_text title="ABOUT VIDEOTUBE"]Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean which is great.
...
CONTENT;
	...
	add_filter( 'vc_load_default_templates', 'videotube_core_home_v5_1col_right_sidebar', 70, 1 );
}