...
if( !function_exists( 'videotube_core_home_v2_fullwidth_3cols' ) ){
	function videotube_core_home_v2_fullwidth_3cols($data) {
		$template               = array();
		$template['name']       = __( 'Homepage V2 - Fullwidth - 3 Cols', 'videotube-core' );
		...
		$template['custom_class'] = 'videotube_core_home_v2_fullwidth_3cols';
...
CONTENT;
	...
	add_filter( 'vc_load_default_templates', 'videotube_core_home_v2_fullwidth_3cols', 40, 1 );
}
