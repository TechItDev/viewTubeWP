...
if( !function_exists( 'videotube_core_vc_post1col' ) ){
	function videotube_core_vc_post1col() {
		// add the shortcode.
		add_shortcode( 'videotube_core_vc_post1col' , 'videotube_core_vc_post1col_shortcode');
		// map the widget.
		...
		$args = array(
			...
			'base'	=>	'videotube_core_vc_post1col',
	...
	add_action( 'init' , 'videotube_core_vc_post1col');
}

if( !function_exists( 'videotube_core_vc_post1col_shortcode' ) ){
	/**
	 * call the widget
	 ...
	 * @return string
	 */
	function videotube_core_vc_post1col_shortcode( $atts, $content = null ) {
		ob_start();
