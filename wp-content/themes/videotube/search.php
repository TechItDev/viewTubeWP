			...
			<div id="primary" class="content-area col-lg-8 col-md-8 col-sm-12">
            	<header class="section-header d-md-flex align-items-center justify-content-between">
            		...
            		<?php if( $wp_query->found_posts > 1 ):?>
                    	<h1 class="page-title"><?php printf( __('About %s results','videotube') , $wp_query->found_posts )?></h1>
                    <?php else:?>
                    	<h1 class="page-title"><?php printf( __('About %s result','videotube') , $wp_query->found_posts )?></h1>
                    <?php endif;?>
