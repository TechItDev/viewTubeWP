...
if( !class_exists( 'VideoTube_Author' ) ){
	class VideoTube_Author{
				...
				$header .= '
                    <div class="channel-header">
						...
						<div class="channel-info">
							...
							<span class="channel-item"><strong>'.__('Videos:','videotube').'</strong> '.videotube_get_user_postcount($user_id).'</span>
							<span class="channel-item"><strong>'.__('Likes:','videotube').'</strong> '.videotube_get_user_metacount($user_id, 'like_key').'</span>
							<span class="channel-item"><strong>'.__('Views:','videotube').'</strong> '.videotube_get_user_metacount($user_id, 'count_viewed').'</span>
							';
		...
		function videotube_author_loop_before(){
			...
			if( $videotube['enable_channelpage'] == 1 ){
				return '<div class="video-section"><div class="row row-5">';	
			}			
		}
